//localStorage --> recurso do navegador que permite armazenamento: inserção pelo setItem(chave,valor[String])
function nextId() {
    const foods = readAll();
  ...
  function create(food) { //inserir no localStorage
    food = { id: nextId(), ...food };
  ...
  function readAll() { //para trazer tudo
